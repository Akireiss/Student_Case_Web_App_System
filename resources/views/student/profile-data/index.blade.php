...
<div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white">
    <div class="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
        ...
        <a href="" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"  class="w-5 h-5 mb-2 group-hover:text-white">
        ...
        <a href="{{ url('student/profile/data/'  .$form->id. '/view') }}" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"   class="w-5 mb-2 h-5 group-hover:text-white">
