        ...
        <x-slot name="slot">
            ...
            <x-grid columns="3" gap="4" px="0" mt="0">
                ...
                <div class="relative mb-3 px-4">
                    ...
                    <x-input value="{{ $profile->student->first_name }}" />
                </div>
                ...
                <div class="relative mb-3 px-4">
                    ...
                    <x-input value="{{ $profile->student->last_name }}" />
                </div>
                ...
                <div class="relative mb-3 px-4">
                    ...
                    <x-input value="{{ $profile->nickname }}" />
                </div>
                ...
                <div class="relative mb-3 px-4">
                    ...
                    <x-input type="date" value="{{ $profile->birthdate }}"/>
                </div>
                ...
                <div class="relative mb-3 px-4">
                    ...
                    <x-input value="{{ $profile->no_of_siblings }}" />
                </div>
                ...
                <div class="relative mb-3 px-4">
                    ...
                    <x-input value="{{ $profile->religion }}" />
                </div>
                ...
                <div class="relative mb-3 px-4">
                    ...
                    <x-input value="{{ $profile->mother_tongue }}" />
                </div>
                ...
                <div class="relative mb-3 px-4">
                    ...
                    <x-input value="{{ $profile->birth_place}}" />
            ...
            <x-grid columns="3" gap="4" px="0" mt="0">
                <div class="relative mb-3 px-4">
                    ...
                    <x-input :value="$profile->province?->province ?? 'No Data'" />
                </div>

                <div class="relative mb-3 px-4">
                    <x-label>Municipality</x-label>
                    <x-input :value="$profile->municipal?->municipality ?? 'No Data'" />
                </div>

                <div class="relative mb-3 px-4">
                    <x-label>Barangay</x-label>
                    <x-input :value="$profile->barangay?->barangay ?? 'No Data'" />
                </div>
            </x-grid>
                    ...
                    @foreach ($profile->family as $familyMember)
                        @if ($familyMember->type === 0)
                            ...
                            <div class="relative mb-3 px-4">
                                ...
                                <x-input value="{{ $familyMember->parent_name ?? 'No Data' }}" />
                            </div>
                            ...
                            <div class="relative mb-3 px-4">
                                ...
                                <x-input value="{{ $familyMember->parent_age ?? 'No Data' }}" />
                            </div>
                            ...
                            <div class="relative mb-3 px-4">
                                ...
                                <x-input value="{{ $familyMember->parent_occupation ?? 'No Data' }}" />
                            </div>
                            ...
                            <div x-data="{ phoneNumber: '' }" class="relative mb-3 px-4">
                                ...
                                <x-input value="{{ $familyMember->parent_contact ?? 'No Data' }}" />
                            </div>
                            ...
                            <div class="relative mb-3 px-4">
                                ...
                                <x-input value="{{ $familyMember->parent_office_contact ?? 'No Data' }}" />
                            </div>
                            <div class="relative mb-3 px-4">
                                <x-label>
                                    Monthly Income
                                </x-label>
                                <x-input value="{{ $familyMember->parent_monthly_income ?? 'No Data' }}" />
                            </div>
                            ...
                            <div class="relative mb-3 px-4">
                                ...
                                <x-input value="{{ $familyMember->parent_birth_place ?? 'No Data' }}" />
                            </div>
                            <div class="relative mb-3 px-4">
                                Place of Work

                                <x-input value="{{ $familyMember->parent_work_address ?? 'No Data' }}" />
                            </div>
                        @endif
                    @endforeach
                @else
                    ...
                    @foreach ($profile->siblings as $sibling)
                        <x-grid columns="3" gap="4" px="0" mt="0">
                            <div class="relative mb-3 px-4">
                                ...
                                <x-input :value="$sibling->sibling_name" />
                            </div>
                            <div class="relative mb-3 px-4">
                                <x-label for="age">
                                    Age
                                </x-label>
                                <x-input :value="$sibling->sibling_age" type="number" />
                            </div>
                            <div class="relative mb-3 px-4">
                                <x-label for="grade_section">
                                    Grade and Section
                                </x-label>
                                <x-input :value="$sibling->sibling_grade_section" />
                            </div>
                        </x-grid>
                    @endforeach
                @else
                    <div class="px-4">
                        <x-input placeholder="No Data" />
                @endif
            </div>
</div>
...
<div class="px-4">
    ...
    <div>
        <h6 class="text-sm my-1 px-4 font-bold uppercase mt-3">
            Parent Status <code>check which applies</code>
        </h6>

        <x-grid columns="4" gap="4" px="4" mt="2">
            @foreach(['Living Together', 'Separated', 'Legally Separated',
             'With another partner', 'Father is OFW', 'Mother is OFW'] as $status)
                <div class="relative mb-3">
                    <x-checkbox
                        name="parent_status[]"
                        wire:model="parentStatuses"
                        value="{{ $status }}"
                        {{ in_array($status, $parentStatuses) ? 'checked' : '' }}
                    />
...
<x-grid columns="3" gap="4" px="0" mt="0">
    ...
    <div class="relative mb-3 px-4">
        ...
        <x-input value="{{ $profile->guardian_name }}" />
    </div>
    ...
    <div class="relative mb-3 px-4">
        ...
        <x-input value="{{ $profile->guardian_relationship }}" />
    </div>
    ...
    <div class="relative mb-3 px-4">
        ...
        <x-input value="{{ $profile->guardian_contact }}" />
    </div>
    ...
    <div class="relative mb-3 px-4">
        ...
        <x-input value="{{ $profile->guardian_age }}" type="number" />
    </div>
    ...
    <div class="relative mb-3 px-4">
        ...
        <x-input value="{{ $profile->guardian_address }}" />
    </div>
...
<div>
        ...
        @foreach ($sortedEducation as $education)
            ...
            <x-grid columns="3" gap="4" px="0" mt="0">
                <div class="relative mb-3 px-4">
                    ...
                    <x-input :value="$education->school_name" id="name" />
                </div>

                <div class="relative mb-3 px-4">
                    <x-label for="section">Section</x-label>
                    <x-input :value="$education->grade_section" id="section" />
                </div>

                <div class="relative mb-3 px-4">
                    <x-label for="school_year">School Year</x-label>
                    <x-input :value="$education->school_year" id="school_year" />
                </div>
            </x-grid>
            ...
            @foreach ($profile->awards as $award)
                <x-grid columns="2" gap="4" px="0" mt="0">
                    <div class="relative mb-3 px-4">
                        ...
                        <x-input :value="$award->award_name" />
                    </div>
                    ...
                    <div class="relative mb-3 px-4">
                        ...
                        <x-input :value="$award->award_year" type="number" />
                    </div>
                </x-grid>
            @endforeach
        @else
    ...
    <x-grid columns="3" gap="4" px="0" mt="0">
        ...
        <div class="relative mb-3 px-4">
            ...
            <x-input value="{{ $profile->favorite_subject }}" />
        </div>
        ...
        <div class="relative mb-3 px-4">
            ...
            <x-input value="{{ $profile->difficult_subject }}" />
        </div>
        ...
        <div class="relative mb-3 px-4">
            ...
            <x-input value="{{ $profile->school_organization }}" />
        </div>
    </x-grid>
    ...
    <x-grid columns="3" gap="4" px="0" mt="0">
        ...
        <div class="relative mb-3 px-4">
            ...
            <x-input value="{{ $profile->disability }}" />
        </div>
        ...
        <div class="relative mb-3 px-4">
            ...
            <x-input value="{{ $profile->food_allergy }}" />
        </div>
    </x-grid>
    ...
    <x-grid columns="3" gap="4" px="0" mt="0">
        ...
        @else
            @foreach ($profile->medicines as $medicine)
                <div class="relative mb-3 px-4">
                    <x-input value="{{ $medicine->medicine }}" />
                </div>
            @endforeach
        @endif
    </x-grid>
    ...
    <x-grid columns="3" gap="4" px="0" mt="0">
        @if ($profile->vitamins->isNotEmpty())
            @foreach ($profile->vitamins as $vitamin)
                <div class="relative mb-3 px-4">
                    <x-input :value="$vitamin->vitamins" />
                </div>
            @endforeach
        @else
            <div class="px-4 py-2">
    ...
    <x-grid columns="3" gap="4" px="0" mt="0">
        @if ($profile->accidents->isNotEmpty())
            @foreach ($profile->accidents as $accident)
                <div class="relative mb-3 px-4">
                    <x-input value="{{ $accident->accidents }}" />
                </div>
            @endforeach
        @else
            <div class="px-4 py-2">
    ...
    <x-grid columns="3" gap="4" px="0" mt="0">
        @if ($profile->operations->isNotEmpty())
            @foreach ($profile->operations as $operation)
                <div class="relative mb-3 px-4">
                    <x-input value="{{ $operation->operations }}" />
                </div>
            @endforeach
        @else
            <div class="px-4 py-2">
