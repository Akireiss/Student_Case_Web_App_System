...
<body>
    ...
    <div x-data="{ isSideMenuOpen: false }">
            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul class="mt-6">
                    <li class="relative px-6 py-3">
                        ...
                        <span class=" {{ (request()->is('admin/dashboard'))  ? ' absolute inset-y-0 left-0 w-1 bg-green-600 rounded-tr-lg rounded-br-lg' : '' }}
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        <span class=" {{ (request()->is('admin/reports'))  ? ' absolute inset-y-0 left-0 w-1 bg-green-600 rounded-tr-lg rounded-br-lg' : '' }}
                            aria-hidden="true"></span>
                    ...
                    <li class="relative px-6 py-3">
                        <span class=" {{ (request()->is('admin/student-profile'))  ? ' absolute inset-y-0 left-0 w-1 bg-green-600 rounded-tr-lg rounded-br-lg' : '' }}
                            aria-hidden="true"></span>
        ...
        <aside
            class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-700 md:hidden"
