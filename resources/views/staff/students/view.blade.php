                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div class="w-full px-4">
                        <div class="relative mb-3">
                            ...
                            <x-input type="text" name="first_name" required value="{{ $student->first_name }}" />
                    ...
                    <div class="w-full px-4">
                        <div class="relative mb-3">
                            ...
                            <x-input type="text" name="middle_name" required value="{{ $student->middle_name }}" />
                        </div>
                    </div>
                    ...
                    <div class="w-full px-4">
                        <div class="relative mb-3">
                            ...
                            <x-input type="text" name="last_name" required value="{{ $student->last_name }}" />
                    ...
                    <div class="w-full px-4">
                        <div class="relative mb-3">
                            ...
                            <x-input type="number" value="{{ $student->lrn }}" name="lrn" required />
                        </div>
                    </div>
                    ...
                    <div class="w-full px-4">
                        <div class="relative mb-3">
                            ...
                            <x-input required value="{{ $student->classroom->grade_level }}" />
                        </div>
                    </div>
                    ...
                    <div class="w-full px-4">
                        <div class="relative mb-3">
                            ...
                            <x-input
                            value="{{ $student->getStatusTextAttribute() }}"
                            />
                        </div>
                    </div>
                    ...
                    <x-slot name="slot">
                        ...
                        <x-grid columns="2" gap="4" px="0" mt="0">
                            ...
                            <div class="w-full px-4">
                                ...
                                <x-input type="text" name="offenses"
                                    value="{{ $report->students->first_name }} {{ $report->students->last_name }}"
                                    disabled />
                            </div>
                        ...
                        <x-grid columns="2" gap="4" px="0" mt="4">
                            <div class="w-full px-4">
                                ...
                                <x-input value="{{ $report->Minoroffenses?->offenses ?? 'No Offenses Found' }}" disabled />
                            </div>
                            ...
                            <div class="w-full px-4">
                                ...
                                <x-input value="{{ $report->Graveoffenses?->offenses ?? 'No Offenses Found' }}" disabled />
                            </div>
                        </x-grid>
                                    ...
                                    @if ($report->letter)
                                        ...
                                        <div x-show="isZoomed" @click.away="isZoomed = false"
                                            ...
                                            <img src="{{ asset('storage/' . $report->letter) }}" alt="Zoomed Letter Image"
                                                class="w-4/5 h-4/5 object-cover cursor-pointer"
                                                @click="isZoomed = !isZoomed">
                                        </div>
                                    @else
