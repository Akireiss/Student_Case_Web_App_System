...
<div class="flex items-center lg:px-44 text-gray-600 hover:text-gray-900 mt-4 mx-4">
    <a href="#" class="text-2xl font-bold text-green-500 ">
        CZCMNHS
    </a>
</div>
        <div class="w-full lg:w-4/12 px-4 mx-auto flex justify-center mt-12 lg:mt-28">
            <div class="relative flex flex-col min-w-0 break-words bg-gray-100 w-96   mb-6 shadow-md rounded-lg mt-16">
                <div class="px-6">
            ...
            QrCode::format('png')->merge(public_path('logo.PNG'), 0.3, true)->size(200)->generate(url('/student/profile/data/' . $form->id)),
                    ...
                    <div class="text-center mt-6">
                        <h3 class="leading-normal text-gray-600 mb-2 font-bold uppercase">
                    ...
                    <div class="w-full px-4 text-center mt-3 md:mt-3">
                        <div class="flex justify-center py-4 lg:pt-4 pt-8">
                            ...
                            <a href="{{ url('student/profile/data/' . $form->id) }}" class="mr-4 p-3 text-center flex flex-col items-center ">
                                ...
                                <span class="text-sm  text-gray-600 font-bold text-center mt-2 border-b
                                border-green-500 uppercase">Profile</span>
                            </a>
                            ...
                            <a href="{{ url('student/profile/data/' . $form->id . '/view') }}" class="mr-4 p-3 text-center flex flex-col items-center">
                                ...
                                <span class="text-sm text-gray-600 font-bold hover:border-b hover:border-green-500 uppercase">View</span>
                            </a>
                            ...
                            <a href="{{ url('student-profile/data/' . $form->id . '/edit') }}" class="mr-4 p-3 text-center flex flex-col items-center">
                                ...
                                <span class="text-sm text-gray-600 font-bold hover:border-b hover:border-green-500 uppercase">Edit</span>
                            </a>
                            ...
                            <a href="{{ url('student/view/cases/' . $form->student->id) }}" class="lg:mr-4 p-3 text-center flex flex-col items-center">
                                ...
                                <span class="text-sm text-gray-600 font-bold hover:border-b hover:border-green-500 uppercase">Cases</span>
                            </a>
        ...
        <footer class="relative pt-5 pb-6 mt-8">
