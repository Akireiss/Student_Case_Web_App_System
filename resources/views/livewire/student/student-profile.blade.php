                    ...
                    @for ($gradeLevel = 7; $gradeLevel <= 12; $gradeLevel++)
                        <div class="w-full px-4">
                            ...
                            <div class="relative mb-3">
                                ...
                                <x-input wire:model="education.{{ $gradeLevel }}.name" id="name_{{ $gradeLevel }}" class="w-full" />
                            </div>
                            <div class="relative mb-3">
                                <x-label for="section_{{ $gradeLevel }}">Section</x-label>
                                <x-input wire:model="education.{{ $gradeLevel }}.section" id="section_{{ $gradeLevel }}" class="w-full" />
                            </div>
                            <div class="relative mb-3">
                                <x-label for="school_year_{{ $gradeLevel }}">School Year</x-label>
                                <x-input wire:model="education.{{ $gradeLevel }}.school_year" id="school_year_{{ $gradeLevel }}" class="w-full" />
                            </div>
                        </div>
                    @endfor
                </x-grid>
