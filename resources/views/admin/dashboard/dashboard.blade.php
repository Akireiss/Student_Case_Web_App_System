        ...
        <div class="grid gap-6 mb-3 md:grid-cols-3 xl:grid-cols-3">
            ...
            <div class="flex items-center p-4 bg-white shadow-md border-l-4 border-blue-500">
                <div class="p-3 mr-4 text-white bg-red-500 rounded-full ">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" height="1em" viewBox="0 0 320 512" fill="white">
            ...
            <div class="flex items-center p-4 bg-white border-pink-500 border-l-4 shadow-md">
                <div class="p-3 mr-4 text-white bg-green-500 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" height="1em" viewBox="0 0 320 512" fill="white">
                        <path d="M160 0a48 48 0 1 1 0 96 48 48 0 1 1 0-96zM88 384H70.2c-10.9 0-18.6-10.7-15.2-21.1L93.3 248.1 59.4 304.5c-9.1
