        ...
        <x-grid columns="3" gap="4" px="0" mt="4">
            <div class="w-full px-4">
                <div class="relative mb-3">
                    ...
                    <x-input type="text" name="observation" disabled value="{{ $anecdotal->observation ?? 'No observation' }}" />
            ...
            <div class="w-full px-4">
                <div class="relative mb-3">
                    ...
                    <x-input type="text" name="observation" disabled value="{{ $anecdotal->desired ?? 'No Desired' }}" />
                </div>
            </div>
        ...
        <x-grid columns="3" gap="4" px="0" mt="4">
            ...
            <div class="w-full px-4">
                <div class="relative mb-3">
                    ...
                    <x-input type="text" name="short_description"  disabled value="{{ $anecdotal->short_description ?? '' }}" />
                </div>
            </div>
            <div class="w-full px-4">
